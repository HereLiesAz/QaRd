...
/**
 * Creates circles instead of squares while drawing the QRCode. By default,
 * the circles will keep `8% of the squareSize` pixels away from each
 * other, to have a more pleasing aesthetics.
 *
 * @param squareSize How big each "square" will be, in pixels (defaults to
 *    [DEFAULT_CELL_SIZE])
 * @param innerSpace How much space inside each "square" will be left empty
 *    (1 = 1px of the inner area won't be drawn)
 */
